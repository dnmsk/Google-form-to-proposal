/*
  ...
  for question 'Offered products' with checkboxes with checked values 'Product_1' and 'Product_2' will be:
  {option cost='300' name='Offered products' value='Product_1'}Product_1: {cost} €{/option} - render 'Product_2: 300 €'
  {option cost='600' name='Offered products' value='Product_2'}Product_2: {cost} €{/option} - render 'Product_2: 600 €' 
...
var settings = {
  ...
  corporateNameQuestion: 'CORPORATE'
}
